...
== Upgrade Notice ==
* 5.4.8: Added reporting notifications and audit log bulk actions, improved AJAX/table handling and upgrade performance, and fixed multiple login, multisite, UTF-8, and compatibility issues across the plugin.
